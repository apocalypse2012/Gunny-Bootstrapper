...
import config_func
from config_marshall import ValidEnvars, ConfigPath
from constants import *

CONFIG_VERSION = 1


ENVAR_VALUES = {ENVAR_GUNNY_ROOT: '$' + ENVAR_GUNNY_ROOT,
                ENVAR_TOOLS_PATH: '$' + ENVAR_GUNNY_ROOT + '\\' + 'gds' + '\\' + 'Pipeline',
                ENVAR_DCC_PATH: '$' + ENVAR_TOOLS_PATH + '\\' + 'DCC',
                ENVAR_PY_PACKAGES_PATH: '$' + ENVAR_TOOLS_PATH + '\\shared\\python',
                ENVAR_PY_PACKAGES_3RDPARTY_PATH: '$' + ENVAR_TOOLS_PATH + '\\shared\\python\\3rdparty\\native_2x',
                }
ENVAR_TYPE = namedtuple('ENVAR_TYPE', (ENVAR_GUNNY_ROOT, ENVAR_TOOLS_PATH, ENVAR_DCC_PATH, ENVAR_PY_PACKAGES_PATH, ENVAR_PY_PACKAGES_3RDPARTY_PATH))
...
CONFIG_INFO_DEFAULT = {
    ...
    ENVAR_GUNNY_ROOT: ValidEnvars(ENVAR_GUNNY_ROOT),
    ENVAR_COMPANY: 'GUNNY',
...
CONFIG_INFO_TYPE = namedtuple(CONFIG_INFO_TYPENAME, (COMMENT_QUALIFIER, ENVAR_GUNNY_ROOT, ENVAR_COMPANY, 'configVer',
...
#     COMMENT_QUALIFIER: defaults.PROPERTIES_CONFIG_COMMENT,
#     'gDebug': False,
#     'gDevMode': False,
#     'gWingConnect': False,
#     'gSpewOutput': False,
#     'WINGHOME': None,
#     TEMPLATE_QUALIFIER: 'example_value'
# }
# CONFIG_PROPERTIES_TYPE = namedtuple('CONFIG_PROPERTIES_TYPE', (COMMENT_QUALIFIER, 'gDebug', 'gDevMode', 'gWingConnect',
#                                                                'gSpewOutput', 'WINGHOME', TEMPLATE_QUALIFIER))
# CONFIG_PROPERTIES = CONFIG_PROPERTIES_TYPE(**CONFIG_PROPERTIES_DEFAULT)._asdict()
#

CONFIG_GUNNY_DEFAULT = {
    COMMENT_QUALIFIER: defaults.MAX_PLAY_CONFIG_COMMENT,
    DESC_CONFIG_PROJECT: ConfigPath(paths=[ValidEnvars(ENVAR_GUNNY_ROOT), ], flags=[
                               ABSOLUTE_PATH_FLAG]),
...
CONFIG_GUNNY_TYPE = namedtuple(CONFIG_GUNNY_TYPENAME, (COMMENT_QUALIFIER, DESC_CONFIG_PROJECT, ENVAR_TOOLS_PATH, ENVAR_PY_PACKAGES_PATH,
                                                       ENVAR_PY_PACKAGES_3RDPARTY_PATH, TEMPLATE_QUALIFIER + str('1'),
                                                       TEMPLATE_QUALIFIER + str('2')))
CONFIG_GUNNY = CONFIG_GUNNY_TYPE(**CONFIG_GUNNY_DEFAULT)._asdict()


CONFIG_DCC_TYPE = namedtuple(CONFIG_DCC_TYPENAME, (DESC_CONFIG_DCC, APP_VERSION, EXECUTABLE_COMMAND, BOOTSTRAP_TYPE,
...
CONFIGURATION_DEFAULT = {DESC_CONFIG_INFO: CONFIG_INFO,
                         # DESC_CONFIG_PROPERTIES: CONFIG_PROPERTIES,
                         DESC_CONFIG_GUNNY: CONFIG_GUNNY,
                         DESC_CONFIG_DCC: [CONFIG_MAYA_2016,
                                           CONFIG_MAYAPY_2016,
                                           CONFIG_MAYA_2015,
                                           CONFIG_MAYA_2014,
                                           CONFIG_3DSMAX_2016,
                                           CONFIG_3DSMAX_2015,
                                           CONFIG_BLENDER]#,
                         # DESC_CONFIG_USER: CONFIG_USER
                         }
CONFIGURATION_TYPE = namedtuple(CONFIG_DATA_TYPENAME, (DESC_CONFIG_INFO, DESC_CONFIG_GUNNY, DESC_CONFIG_DCC))
