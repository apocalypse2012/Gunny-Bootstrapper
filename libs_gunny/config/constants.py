...
EXPORT_RELATIVE = str('Export_Subdir')
ASSET_COMMON = str('Common')
DCC_PROJECT = str('Dcc_Project_File')
MAX_FILE_TYPE = str('MaxFile')
MAYA_FILE_TYPE = str('MayaFile')
BLENDER_FILE_TYPE = str('BlendFile')
TGA_FILE_TYPE = str('TgaFile')
BMP_FILE_TYPE = str('BmpFile')
PNG_FILE_TYPE = str('PngFile')
PSD_FILE_TYPE = str('PsdFile')
...
CONFIG_PROJECT_TYPENAME = str('CONFIG_PROJECT_TYPE')
